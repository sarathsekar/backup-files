...
<?php } }?>
                  ...
                  <p align="right">   <a href="photographerDashboard.php" class="anima-button circle-button btn-sm btn" adr_trans="label_back_home"><i class="fa fa-sign-out"></i>Back To Home</a></p>
