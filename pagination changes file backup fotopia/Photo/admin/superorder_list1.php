  ...
  <div  style="width:100%;overflow:scroll;">
      ...
      <table class="" aria-busy="false" style="width:100% !important">
         ...
         if(  $get_name=mysqli_fetch_assoc($get_realtor_name_query))
         {
          ...
          <td class="text-center" style="word-break:break-all;"><?php
  ...
  <?php } ?></td>
    ...
    ?></td>
     ...
     <td class="text-center" style=""><?php echo date('d/m/Y ',strtotime($get_order['order_due_date'])); ?></td>
                          ...
                          <td class="text-center"  style=""><a onclick="mouseover(<?php echo $get_order['id']; ?>)"><?php $status=$get_order['status_id']; if($status==1) { echo "<span style='color:green;font-weight:bold;' id='label_created' adr_trans='label_created'>Created</span>"; } elseif($status==2){echo "<span style='color:brown;font-weight:bold;' id='label_wip' adr_trans='label_wip'>WIP</span>";}elseif($status==3){echo "<span style='color:green;font-weight:bold;' id='label_completed' adr_trans='label_completed'>completed</span>";}elseif($status==4){echo "<span style='color:green;font-weight:bold;' id='label_rework' adr_trans='label_rework'>Rework</span>";}elseif($status==6){echo "<span style='color:red;font-weight:bold;' id='label_declined' adr_trans='label_declined'>Declined </span>";}elseif($status==7){echo "<span style='color:orange;font-weight:bold;' id='label_working_customer' adr_trans='label_working_customer'>Working With Customer </span>";}elseif($status==5){echo "<span style='color:Red;font-weight:bold;'>Cancelled </span>";}?><?php if($status==5||$status==6||$status==7){ echo "  <i class='fa fa-question-circle' aria-hidden='true' title='Click to view the reason'></i>";}?></a></td>
  ...
  <?php } ?></td>
      ...
      <td class="text-center" style=""><?php echo $get_order['property_address']; ?></td>
          ...
          <td class="text-center" style=""><?php echo date('d/m/Y ',strtotime($get_order['order_due_date'])); ?></td>
                                  ...
                                  <td class="text-center"  style=""><a onclick="mouseover2(<?php echo $get_order['id']; ?>)"><?php $status=$get_order['status_id']; if($status==1) { echo "<span style='color:green;font-weight:bold;' id='label_created' adr_trans='label_created'>Created</span>"; } elseif($status==2){echo "<span style='color:brown;font-weight:bold;' id='label_wip' adr_trans='label_wip'>WIP</span>";}elseif($status==3){echo "<span style='color:green;font-weight:bold;' id='label_completed' adr_trans='label_completed'>completed</span>";}elseif($status==4){echo "<span style='color:green;font-weight:bold;' id='label_rework' adr_trans='label_rework'>Rework</span>";}elseif($status==6){echo "<span style='color:red;font-weight:bold;' id='label_declined' adr_trans='label_declined'>Declined</span>";}elseif($status==7){echo "<span style='color:orange;font-weight:bold;' id='label_working_customer' adr_trans='label_working_customer'>Working with Customer</span>";}elseif($status==5){echo "<span style='color:Red;font-weight:bold;'>Cancelled</span>";}?><?php if($status==5||$status==6||$status==7){ echo "  <i class='fa fa-question-circle' aria-hidden='true' title='Click to view the reason'></i>";}?></a></td>
                                      <td class="text-center" style=""><a target="" href="superOrder_detail.php?id=<?php echo $get_order['id']; ?>" class="link">
          <i class="fa fa-external-link"></i></a></td>
  ...
  <div  style="width:100%;overflow:scroll;">
      ...
      <table class="" aria-busy="false" style="width:100% !important">
        ...
        <!-- <span class="icon fa "></span></a></th><th  class="text-center" style=""><a href="javascript:void(0);" class="column-header-anchor sortable"><span class="text" id="label_product" adr_trans="label_product">
          ...
          //SELECT count(*) as total FROM orders where photographer_id='$loggedin_id' or created_by_id='$loggedin_id'
          $q1="SELECT count(*) as total FROM orders where pc_admin_id=$loggedin_id  and status_id in (2,4) ";
          $result=mysqli_query($con,$q1);
          $data=mysqli_fetch_assoc($result);
          $total_no=$data['total'];
          $number_of_pages=5;
          ...
          $limit=$start_no_users . ',' . $number_of_pages;
          $get_order_query=mysqli_query($con,"SELECT * FROM orders where pc_admin_id=$loggedin_id and status_id in (2,4)  order by id desc limit $limit");
          if($get_order_query == "0"){
    ...
    <?php } ?></td>
      <td class="text-center" style=""><?php echo $get_order['property_address'];; ?></td>
          ...
          <td class="text-center" style=""><?php echo date('d/m/Y ',strtotime($get_order['order_due_date'])); ?></td>
                          ...
                          <td class="text-center" style=""><?php $status=$get_order['status_id']; if($status==1) { echo "<span style='color:green;font-weight:bold;' id='label_created' adr_trans='label_created'>Created</span>"; } elseif($status==2){echo "<span style='color:brown;font-weight:bold;' id='label_wip' adr_trans='label_wip'>WIP</span>";}elseif($status==3){echo "<span style='color:green;font-weight:bold;' id='label_completed' adr_trans='label_completed'>completed</span>";}elseif($status==4){echo "<span style='color:green;font-weight:bold;' id='label_rework' adr_trans='label_rework'>Rework</span>";}elseif($status==6){echo "<span style='color:green;font-weight:bold;' id='label_declined' adr_trans='label_declined'>Decline</span>";}?></td>
                                      <td class="text-center" style=""><a target="" href="superOrder_detail.php?id=<?php echo $get_order['id']; ?>" class="link">
          <i class="fa fa-external-link"></i></a></td>
      ...
      <?php } ?>
                          <div id="undefined-footer" class="bootgrid-footer container-fluid">
                            <div class="row"><div class="col-sm-6">
                              <ul class="pagination">
                                <li class="first disabled" aria-disabled="true"><a href="./superorder_list1.php?page=1&o=1" class="button adr-save">«</a></li>
                                <li class="prev disabled" aria-disabled="true"><a href="<?php echo "./superorder_list1.php?o=1&page=".($_SESSION["page"]-1);?>" class="button adr-save">&lt;</a></li>
                                <li class="page-1 active" aria-disabled="false" aria-selected="true"><a href="#1" class="button adr-save"><?php echo $_SESSION["page"]; ?></a></li>
                                <li class="next disabled" aria-disabled="true"><a href="<?php echo "./superorder_list1.php?o=1&page=".($_SESSION["page"]+1);?>" class="button adr-save">&gt;</a></li>
                                <li class="last disabled" aria-disabled="true"><a href="<?php echo "./superorder_list1.php?o=1&page=".($Page_check);?>" class="button adr-save">»</a></li></ul></div>
                                <div class="col-sm-6 infoBar"style="margin-top:24px">
                                <div class="infos"><p align="right"><span adr_trans="label_showing">Showing</span> <?php  if(($start_no_users+1)<0){ echo "0";}else{ echo $start_no_users+1;}?><span adr_trans="label_to">  to</span> <?php if($cnt<0){ echo "0";}else{ echo $cnt;} ?> of <?php echo $total_no; ?><span adr_trans="label_entries">  entries</span></p></div>
                                </div>
                              </div>
      ...
      <?php } ?></td>
        <td class="text-center" style=""><?php echo $get_order['property_address'];; ?></td>
            ...
            <td class="text-center" style=""><?php echo date('d/m/Y ',strtotime($get_order['order_due_date'])); ?></td>
                            ...
                            <td class="text-center" style=""><?php $status=$get_order['status_id']; if($status==1) { echo "<span style='color:green;font-weight:bold;' id='label_created' adr_trans='label_created'>Created</span>"; } elseif($status==2){echo "<span style='color:brown;font-weight:bold;' id='label_wip' adr_trans='label_wip'>WIP</span>";}elseif($status==3){echo "<span style='color:green;font-weight:bold;' id='label_completed' adr_trans='label_completed'>completed</span>";}elseif($status==4){echo "<span style='color:green;font-weight:bold;' id='label_rework' adr_trans='label_rework'>Rework</span>";}elseif($status==6){echo "<span style='color:green;font-weight:bold;'>Decline</span>";}?></td>
                                        <td class="text-center" style=""><a target="" href="superOrder_detail.php?id=<?php echo $get_order['id']; ?>" class="link">
            <i class="fa fa-external-link"></i></a></td>
          <?php
          ...
          <?php } } ?>
                          ...
                          <div id="undefined-footer" class="bootgrid-footer container-fluid">
                            <div class="row"><div class="col-sm-6">
                              <ul class="pagination">
                                <li class="first disabled" aria-disabled="true"><a href="./superorder_list1.php?page=1&c=1" class="button adr-save">«</a></li>
                                <li class="prev disabled" aria-disabled="true"><a href="<?php echo "./superorder_list1.php?c=1&page=".($_SESSION["page"]-1);?>" class="button adr-save">&lt;</a></li>
                                <li class="page-1 active" aria-disabled="false" aria-selected="true"><a href="#1" class="button adr-save"><?php echo $_SESSION["page"]; ?></a></li>
                                <li class="next disabled" aria-disabled="true"><a href="<?php echo "./superorder_list1.php?c=1&page=".($_SESSION["page"]+1);?>" class="button adr-save">&gt;</a></li>
                                <li class="last disabled" aria-disabled="true"><a href="<?php echo "./superorder_list1.php?c=1&page=".($Page_check);?>" class="button adr-save">»</a></li></ul></div>
                                <div class="col-sm-6 infoBar"style="margin-top:24px">
                                <div class="infos">
