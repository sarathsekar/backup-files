	...
	<?php include "sidebar.php"; ?>
                ...
                <thead>
                    <tr>
                        ...
                        <th><span adr_trans="label_description">Description</th>
                    </tr>
			...
			?>
						<div class="col-sm-6">
									<ul class="pagination ">
										<li class="first disabled" aria-disabled="true"><a href="./csr_products.php?page=1" class="button adr-save">«</a></li>
										<li class="prev disabled" aria-disabled="true"><a href="<?php echo "./csr_products.php?page=".($_SESSION["page"]-1);?>" class="button adr-save">&lt;</a></li>
