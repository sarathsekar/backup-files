...
mysqli_query($con,"update user_actions set is_read=1 where (action_done_by_id='$loggedin_id' or csr_id='$loggedin_id') and is_read=0");
...
<?php } }?>
                  ...
                  <div class="col-sm-6">
                        <ul class="pagination " style="font-weight:bold!important;">
                          <li class="first disabled" aria-disabled="true"><a href="./csr_activity.php?page=1" class="button adr-save">«</a></li>
                          <li class="prev disabled" aria-disabled="true"><a href="<?php echo "./csr_activity.php?page=".($_SESSION["page"]-1);?>" class="button adr-save">&lt;</a></li>
                          <li class="page-1 active" aria-disabled="false" aria-selected="true"><a href="#1" class="button adr-save"><?php echo $_SESSION["page"]; ?></a></li>
                          <li class="next disabled" aria-disabled="true"><a href="<?php echo "./csr_activity.php?page=".($_SESSION["page"]+1);?>" class="button adr-save">&gt;</a></li>
                          <li class="last disabled" aria-disabled="true"><a href="<?php echo "./csr_activity.php?page=".($Page_check);?>" class="button adr-save">»</a></li></ul>  </div>
